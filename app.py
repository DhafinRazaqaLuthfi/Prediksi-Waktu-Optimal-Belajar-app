...
# =====================
st.image(
    "https://media.giphy.com/media/26gslXtQzJZ3X5uA8/giphy.gif",
    caption="📚 Belajar dengan lebih efektif menggunakan AI",
...
st.caption("Aplikasi Deep Learning menggunakan **MLP (PyTorch)**")
